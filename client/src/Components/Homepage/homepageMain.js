...
export const HomepageMain = () => {
    ...
    useEffect(() => {
        setTheme(checkedValue === false ? "cupcake" : "night");
        ...
        <>
            ...
            {checkedValue === false ? (
                <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="w-8 h-8 inline-block mb-4 bg-[#dbc58e] p-1 rounded-xl"
                >
                ...
                <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="w-8 h-8 inline-block mb-4 p-1"
                >
                    <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
